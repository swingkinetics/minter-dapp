...
const namePrefix = "japanese homies";
const description = "japanese warrior homies";
...
const extraMetadata = {
  external_url: "https://descipunks.xyz", // Replace with your website or remove this line if you do not have one.
};
